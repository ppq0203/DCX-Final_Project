...
@Controller
public class gameModalltwoController {
	 ...
	 */
	@RequestMapping(value="/gameModalltwo.com", produces="application/text;charset=utf-8") /* value주소 불러오기 이름*/
	public String gameModall( Model model) {
	    return "content/gameModalltwo";
	}
